...
class ForkDetailViewController: UIViewController {
    ...
    func setAttribute() {
        ...
        self.detailView.contents.list.register(AddForkPictureItemView.self, forCellWithReuseIdentifier: AddForkPictureItemView.id)
...
extension ForkDetailViewController: MapControllerDelegate {
    ...
    func addViewSucceeded(_ viewName: String, viewInfoName: String) {
        ...
        view.viewRect = detailView.contents.map.bounds    //뷰 add 도중에 resize 이벤트가 발생한 경우 이벤트를 받지 못했을 수 있음. 원하는 뷰 사이즈로 재조정.
